...
export default class ScriptProfileRunView extends SelectListView {
  ...
  initializeView() {
    ...
    this.buttons = $$(function () {
      return this.div({ class: 'block buttons' }, () => {
        ...
        return this.button({ class: 'btn run' }, () => this.span({ class: 'icon icon-playback-play' }, 'Run'),
        );
      },
      );
    });
  ...
  viewForItem(item) {
    return $$(function () {
      return this.li({ class: 'two-lines profile' }, () => {
        this.div({ class: 'primary-line name' }, () => this.text(item.name),
      );
        return this.div({ class: 'secondary-line description' }, () => this.text(item.description),
      );
      },
    );
    });
