...
export default class Runner {
  ...
  onDidWriteToStdout(callback) {
    this.emitter.on('did-write-to-stdout', callback);
  }
  ...
  onDidWriteToStderr(callback) {
    this.emitter.on('did-write-to-stderr', callback);
  }
  ...
  onDidExit(callback) {
    this.emitter.on('did-exit', callback);
  }
  ...
  onDidNotRun(callback) {
    this.emitter.on('did-not-run', callback);
  }
