...
export default class Runner {
  ...
  run(command, extraArgs, codeContext, inputString = null) {
    ...
    let args = this.args(codeContext, extraArgs);
    let options = this.options();
    let stdout = this.stdoutFunc;
    let stderr = this.stderrFunc;
  ...
  getCwd() {
    ...
    let workingDirectoryProvided = (cwd != null) && cwd !== '';
  ...
  args(codeContext, extraArgs) {
    ...
    let project_path = this.getProjectPath || '';
