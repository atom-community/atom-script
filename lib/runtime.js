...
export default class Runtime {
  ...
  onStarted(callback) {
    this.emitter.on('started', callback);
  }
  ...
  onDidContextCreate(callback) {
    this.emitter.on('did-context-create', callback);
  }
  ...
  onDidWriteToStdout(callback) {
    this.runner.onDidWriteToStdout(callback);
  }
