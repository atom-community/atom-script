...
export default {
  ...
  // Public: Get the AutoIt3 helper object
  //
  // Returns an {Object} which assists in creating and running temp files containing AutoIt3 code
  AutoItv3: require('./grammar-utils/au3'),
