"use babel" // TODO
/* eslint-disable no-invalid-this */ import ScriptOptions from "../lib/script-options"
...
describe("ScriptOptions", () => {
  ...
  describe("mergedEnv", () => {
    ...
    it("should support special character values", () => {
      this.scriptOptions.env =
        "TEST_VAR_1=o-n-e;TEST_VAR_2=\"nested\\\"doublequotes\\\"\";TEST_VAR_3='nested\\'singlequotes\\'';TEST_VAR_4='s p a c e s'"
      const mergedEnv = this.scriptOptions.mergedEnv(this.dummyEnv)
